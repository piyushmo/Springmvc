...
public class EmployeeDBOperationImpl implements DBOperation {
	...
	private static final String GET_EMPLOYEE_DETAILS_BY_ID = "SELECT EMP_ID,EMP_NAME,EMP_JOB,EMP_SALARY FROM EMPLOYEE_JDBC WHERE EMP_ID=?";
	...
	private static final String  DELETE_EMPLOYEE_JDBC ="DELETE FROM EMPLOYEE_JDBC  WHERE EMP_JOB = ?";
	...
	public int getSalaryById(int no) {
		...
		int salary = jdbcTemplate.queryForInt(GET_EMPLOYEE_SALARY_BY_ID);
	...
	public Map<String, Object> listEmployeeList(int no) {
		...
		Map<String, Object> map = jdbcTemplate.queryForMap(GET_EMPLOYEE_DETAILS_BY_ID);
	...
	public int updateEmployeeSalaryById(int no, int newSalary) {
		...
		int result = jdbcTemplate.update(UPDATE_EMPLOYE_SALARY_BY_ID);
	...
	public int delete(int no) {
		...
		int result = jdbcTemplate.update(DELETE_EMPLOYEE_JDBC);
